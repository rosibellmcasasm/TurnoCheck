...
- Supabase: existe org conectada vía MCP (rosibellmcasasm's Org) con 1 proyecto de OTRA app ("Evoke App", inactivo) — para TurnoCheck se crea un proyecto NUEVO y separado en Sesión 6, no se reutiliza el existente
