...
- Longitud: B2B / herramienta de valor obvio → ≤3 pasos directos al valor. B2C de personalización (bienestar, fitness, finanzas, hábitos) → 15-25 micro-pantallas (ver `02B-ONBOARDING-Y-PAYWALL.md` — la decisión se toma ANTES de diseñar y se anota en ESTADO.md).
