...
- **`24-GAMIFICACION.md`**: la tabla `user_progress` de la racha (y su cálculo en servidor) vive allá — sigue el mismo patrón RLS de este archivo (políticas con `using` + `with check`).
