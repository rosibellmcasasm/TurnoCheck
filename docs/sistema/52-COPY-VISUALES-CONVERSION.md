...
El headline es la pieza con más apalancamiento de toda la landing (Ogilvy: 5 de cada 6 leen solo el titular). Prohibido quedarse con el primer intento. El proceso, en orden y sin saltos:
