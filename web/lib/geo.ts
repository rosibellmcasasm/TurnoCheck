...
/** A qué sitio/proyecto pertenece una marcación — el sitio activo más cercano dentro del
 *  radio de la geocerca. null si no hay ninguno dentro de rango (o no hay sitios
 *  configurados) — para atribuir horas por proyecto en Reportes. */
